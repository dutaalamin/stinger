        ...
        <div className="w-full max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col justify-between h-full pt-[140px] pb-10 lg:pt-[160px] lg:pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-12 items-center flex-1">
            ...
            <div className="relative h-[500px] items-center justify-end hidden lg:flex">
              <div className="flex flex-col gap-[20px] w-[420px] z-10 relative h-[420px]">
                {[
                  ...
                  return (
                    <div
                      key={opt.id}
                      className={`bg-black/60 backdrop-blur-md border border-white/10 text-white/65 px-8 py-5 rounded-2xl flex items-center justify-center text-center cursor-pointer transition-all duration-[400ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] font-medium text-[18px] hover:border-white/20 hover:text-white hover:opacity-85 ${isAct ? '!bg-black !border-white !text-white !opacity-100 !shadow-[0_20px_40px_rgba(0,0,0,0.6),0_0_25px_rgba(255,255,255,0.15)]' : 'shadow-[0_10px_25px_-5px_rgba(0,0,0,0.3)]'}`}
